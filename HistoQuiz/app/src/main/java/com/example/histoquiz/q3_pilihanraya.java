...
public class q3_pilihanraya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.q3_pilihanraya);
        // Initialize views
        ...
        timer = new CountDownTimer(remainingTimeMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(q3_pilihanraya.this, gameover.class);
        ...
        btnNextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (wrongAnswers == 0) {
                    ...
                    Intent intent = new Intent(q3_pilihanraya.this, q4_pilihanraya.class);
                    // Pass score and wrongAnswers as extras
                    intent.putExtra("score", score);
                    intent.putExtra("wrongAnswers", wrongAnswers);
                    intent.putExtra("remainingTimeMillis", remainingTimeMillis);
