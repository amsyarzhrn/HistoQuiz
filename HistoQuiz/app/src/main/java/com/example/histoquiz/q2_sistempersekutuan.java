...
public class q2_sistempersekutuan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.q2_sistempersekutuan);
        // Initialize views
        ...
        timer = new CountDownTimer(remainingTimeMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(q2_sistempersekutuan.this, gameover.class);
        ...
        btnNextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (wrongAnswers <= 0) {
                    ...
                    Intent intent = new Intent(q2_sistempersekutuan.this, q3_sistempersekutuan.class);
                    // Pass score and wrongAnswers as extras
                    intent.putExtra("score", score);
                    intent.putExtra("wrongAnswers", wrongAnswers);
                    intent.putExtra("remainingTimeMillis", remainingTimeMillis);
